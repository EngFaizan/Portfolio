...
export const skills = [
  ...
  },
  {
    ...
    items: ['React.js', 'Next.js', 'Three.js', 'HTML5', 'CSS3', 'Tailwind CSS', 'Bootstrap', 'Responsive Web Design'],
  },
  {
    category: 'Backend Development',
    items: ['Node.js', 'Express.js', 'RESTful APIs', 'Authentication & Authorization', 'JWT', 'RBAC'],
  },
  {
...
export const certifications = [
  // Newest first. These two came from Faizan directly rather than the resume
  // PDF, which predates them — the rest of this file is transcribed from it.
  {
